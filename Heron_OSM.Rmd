...
# downsize df to 1/10 size to play
coords <- coords %>% filter(row_number() %% 10 == 0)

ggplot() +
	geom_tile(data = coords, aes(x = x, y = y, fill = layer, width = 0.001, height = 0.001), position = "identity") +
  scale_fill_gradient2(low = "yellow", mid = "lightblue",
  high = "blue", midpoint = 2, space = "Lab",
  na.value = "grey50", guide = "colourbar", aesthetics = "fill") +
  geom_sf(data = reef$osm_polygons, fill = NA) +    
